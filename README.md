...
```sh
SETUP_DIR=~/workspace/setup SETUP_REF=v2.6.0 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/sakaal/setup/master/setup.sh)"
```
...
```sh
SETUP_REF=v2.6.0 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/sakaal/setup/master/setup.sh)"
```
...
```sh
SETUP_REF=v2.6.0 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/sakaal/setup/v2.6.0/setup.sh)"
```
